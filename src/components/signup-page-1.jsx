...
import { socialButtons } from '@/components/data/signup-page-1-data'
...
export function SignUpPage1() {
  ...
  return (
    <section
      className='from-background to-muted/50 relative isolate flex min-h-dvh w-full flex-col items-center justify-center overflow-hidden bg-linear-to-br'>
      <div
        className='relative z-10 container mx-auto flex min-h-dvh flex-col items-center justify-center px-4 py-12'>
        <Card className='relative w-full max-w-lg ring-0 p-8 shadow-2xl'>
        ...
        <p
          className='text-muted-foreground relative z-10 mt-8 max-w-lg px-8 text-center text-xs text-balance'>
